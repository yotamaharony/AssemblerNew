...
bin:
	...
	branch $zero, $a0, $zero, 0, retm  			# 10: jump to retm if n == 0
	...
	add $a1, $a1, $zero, $zero, 1				# 16: calculate k' + 1
...
retfinal:
	...
	sw	$v0,   $zero, $zero, $zero, 0x102		# 24: save return value in memory
	jr $ra, $zero, $zero, $zero, 0				# 25: and return

retm:
	add $v0, $v0, $zero, $zero, 1		    	# 26: $v0 = 1
	jal $zero, $zero, $zero, $zero, retfinal	# 27: f: go to return